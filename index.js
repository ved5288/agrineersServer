...
app.post('/requestfertilizers',function(req,res){
	...
	var queryString = "INSERT into fertilizerdemand (id,farmerid,fertilizer,quantity,type) values";
...
app.post('/fetchfertilizerdemand',function(req,res){
	...
	var queryString = "SELECT farmerid, name, fertilizer, quantity from fertilizerdemand, farmers where fertilizer ='"+fertName+"'and fertilizerdemand.farmerid=farmers.id";
...
app.post('/fetchfertilizersupply',function(req,res){
	...
	var queryString = "SELECT farmerid, name, fertilizer, quantity from fertilizersupply, farmers where fertilizer ='"+fertName+"' and fertilizersupply.farmerid=farmers.id" ;
